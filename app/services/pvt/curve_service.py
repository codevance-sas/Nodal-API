# backend/app/services/pvt/curve_service.py
import math
import numpy as np
import logging
...
from app.utils.conversions import api_to_sg
...
def calculate_bubble_points(data: PVTInput) -> Dict[str, Any]:
    """
...
def get_recommended_curves(data: PVTInput) -> Dict[str, Any]:
    """
...
def compare_correlations(property_name: str, data: PVTInput) -> Dict[str, Any]:
    """
...
def clear_calculation_cache():
    """
    Clear the calculation cache to force fresh calculations.
    
    Returns:
        Number of entries removed
    """
    global property_calc_cache
    count = len(property_calc_cache)
    property_calc_cache = {}
    return count