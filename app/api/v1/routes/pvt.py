...
@router.post("/api/pvt/curve/recommended")
...
@router.post("/api/pvt/curve/compare/{property_name}")
...
@router.post("/api/pvt/curve/bubble-points")
...
@router.post("/api/pvt/clear-cache")
